import { Component, IComponentOptions } from "./typedoc-component";
 ...
 * @see https://github.com/TypeStrong/typedoc/blob/master/src/lib/output/themes/default/assets/typedoc/components/MenuHighlight.ts
 */
export class MenuHighlight extends Component {
  ...
  constructor(options: IComponentOptions) {
    ...
    Viewport.instance.addEventListener<{ scrollTop: number }>("scroll", (e) =>
      this.onScroll(e)
    );

...
export const defaultLayout = (context: GjsifyThemeContext, props: PageEvent<Reflection>) => (
    <html class="default">
        <head>
            <meta charSet="utf-8" />
            ...
            <link rel="shortcut icon" href={context.relativeURL("assets/favicon.ico")} />
            <link rel="apple-touch-icon" sizes="180x180" href={context.relativeURL("assets/apple-touch-icon.png")} />
            <link rel="icon" type="image/png" sizes="32x32" href={context.relativeURL("assets/favicon-32x32.png")} />
            <link rel="icon" type="image/png" sizes="16x16" href={context.relativeURL("assets/favicon-16x16.png")} />
            <link rel="manifest" href={context.relativeURL("site.webmanifest")} />
            <link rel="mask-icon" href={context.relativeURL("safari-pinned-tab.svg")} color="#4a86cf" />

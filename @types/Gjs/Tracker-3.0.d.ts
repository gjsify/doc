...
export class Notifier {
    ...
    signal_subscribe(connection: Gio.DBusConnection, service: string, object_path: string, graph: string): number
...
export class SparqlConnection {
    ...
    static new(flags: SparqlConnectionFlags, store: Gio.File, ontology: Gio.File, cancellable?: Gio.Cancellable | null): SparqlConnection
...
export class SparqlCursor {
    ...
    get_string(column: number): [ /* returnType */ string, /* length */ number | null ]

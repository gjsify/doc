...
export class AppSrc {
    ...
    connect(sigName: "need-data", callback: (($obj: AppSrc, object: number) => void)): number
    connect_after(sigName: "need-data", callback: (($obj: AppSrc, object: number) => void)): number
    emit(sigName: "need-data", object: number): void
    connect(sigName: "push-buffer", callback: (($obj: AppSrc, object: Gst.Buffer) => Gst.FlowReturn)): number
    connect_after(sigName: "push-buffer", callback: (($obj: AppSrc, object: Gst.Buffer) => Gst.FlowReturn)): number
    emit(sigName: "push-buffer", object: Gst.Buffer): void
    connect(sigName: "push-buffer-list", callback: (($obj: AppSrc, object: Gst.BufferList) => Gst.FlowReturn)): number
    connect_after(sigName: "push-buffer-list", callback: (($obj: AppSrc, object: Gst.BufferList) => Gst.FlowReturn)): number
    emit(sigName: "push-buffer-list", object: Gst.BufferList): void
    connect(sigName: "push-sample", callback: (($obj: AppSrc, object: Gst.Sample) => Gst.FlowReturn)): number
    connect_after(sigName: "push-sample", callback: (($obj: AppSrc, object: Gst.Sample) => Gst.FlowReturn)): number
    emit(sigName: "push-sample", object: Gst.Sample): void
    connect(sigName: "seek-data", callback: (($obj: AppSrc, object: number) => boolean)): number
    connect_after(sigName: "seek-data", callback: (($obj: AppSrc, object: number) => boolean)): number
    emit(sigName: "seek-data", object: number): void
    /* Signals of Gst.Element */

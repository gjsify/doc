...
class Frame {
    ...
    readonly label_widget: Gtk.Widget
    readonly shadow_type: number
    readonly label_xalign: number
    readonly label_yalign: number
    readonly child_allocation: Gtk.Allocation

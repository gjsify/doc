...
export function webdav_discover_content_get_selected(content: Gtk.Widget, index: number): [ /* returnType */ boolean, /* out_href */ string, /* out_supports */ number, /* out_display_name */ string, /* out_color */ string ]
...
export function webdav_discover_content_new(credentials_prompter: CredentialsPrompter, source: EDataServer.Source | null, base_url: string | null, supports_filter: number): Gtk.Widget
export function webdav_discover_content_refresh(content: Gtk.Widget, display_name?: string | null, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
...
export function webdav_discover_dialog_new(parent: Gtk.Window, title: string, credentials_prompter: CredentialsPrompter, source: EDataServer.Source, base_url: string | null, supports_filter: number): Gtk.Dialog

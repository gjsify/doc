...
export class MimeFilter {
    ...
    complete(in_: string[], prespace: number): [ /* out */ string[], /* outprespace */ number ]
    filter(in_: string[], prespace: number): [ /* out */ string[], /* outprespace */ number ]
    reset(): void
    ...
    vfunc_complete(in_: string[], prespace: number): [ /* out */ string[], /* outprespace */ number ]
    vfunc_filter(in_: string[], prespace: number): [ /* out */ string[], /* outprespace */ number ]
    vfunc_reset(): void
    /* Virtual methods of GObject.Object */
    vfunc_constructed(): void
    vfunc_dispatch_properties_changed(n_pspecs: number, pspecs: GObject.ParamSpec): void
...
export class MimeParser {
    ...
    step(databuffer?: string[] | null): [ /* returnType */ MimeParserState, /* databuffer */ string[] | null ]
    stream(): Stream | null
    tell(): number
...
export abstract class MimeFilterClass {
    ...
    parent_class: GObject.ObjectClass
    filter: (filter: MimeFilter, in_: string[], prespace: number) => [ /* out */ string[], /* outprespace */ number ]
    complete: (filter: MimeFilter, in_: string[], prespace: number) => [ /* out */ string[], /* outprespace */ number ]

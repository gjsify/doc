...
function device_check_firmware(device: GUsb.Device, data: Uint8Array[]): boolean
...
function device_mode_from_firmware(data: Uint8Array[]): DeviceMode
...
class DeviceQueue {
    ...
    read_firmware(device: GUsb.Device, data: Uint8Array[]): void
    read_flash(device: GUsb.Device, address: number, data: Uint8Array[]): void
    read_sram(device: GUsb.Device, address: number, data: Uint8Array[]): void
    ...
    verify_firmware(device: GUsb.Device, data: Uint8Array[]): void
    verify_flash(device: GUsb.Device, address: number, data: Uint8Array[]): void
    write_eeprom(device: GUsb.Device, magic: string): void
    write_firmware(device: GUsb.Device, data: Uint8Array[]): void
    write_flash(device: GUsb.Device, address: number, data: Uint8Array[]): void
    write_sram(device: GUsb.Device, address: number, data: Uint8Array[]): void

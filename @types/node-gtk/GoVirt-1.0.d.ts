...
class Proxy {
    ...
    connect(sigName: "notify::admin", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::admin", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::ca-cert", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::ca-cert", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class VmDisplay {
    ...
    connect(sigName: "notify::monitor-count", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::monitor-count", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::secure-port", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::secure-port", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::ticket", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::ticket", callback: ((pspec: GObject.ParamSpec) => void)): number

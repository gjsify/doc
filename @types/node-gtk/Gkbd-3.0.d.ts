...
function keyboardConfigAddDefaultSwitchOptionIfNecessary(layoutsList: string, optionsList: string, wasAppended: boolean): string[]
function keyboardConfigFormatFullDescription(layoutDescr: string, variantDescr: string): string
function keyboardConfigGetDescriptions(configRegistry: Xkl.ConfigRegistry, name: string, layoutShortDescr: string, layoutDescr: string, variantShortDescr: string, variantDescr: string): boolean
function keyboardConfigMergeItems(parent: string, child: string): string
function keyboardConfigSplitItems(merged: string, parent: string, child: string): boolean
function previewLoadPosition(): Gdk.Rectangle
function previewSavePosition(rect: Gdk.Rectangle): void
function strvAppend(arr: string, element: string): string[]
function strvBehead(arr: string): void
function strvRemove(arr: string, element: string): boolean
...
class Configuration {
    ...
    connect(sigName: "group-changed", callback: ((object: number) => void)): number
    on(sigName: "group-changed", callback: (object: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "group-changed", callback: (object: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "group-changed", callback: (object: number) => void): NodeJS.EventEmitter
    emit(sigName: "group-changed", object: number): void
    connect(sigName: "indicators-changed", callback: (() => void)): number
    on(sigName: "indicators-changed", callback: () => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "indicators-changed", callback: () => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "indicators-changed", callback: () => void): NodeJS.EventEmitter
...
class Indicator {
    ...
    connect(sigName: "reinit-ui", callback: (() => void)): number
    on(sigName: "reinit-ui", callback: () => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "reinit-ui", callback: () => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "reinit-ui", callback: () => void): NodeJS.EventEmitter
...
class KeyboardDrawing {
    ...
    connect(sigName: "bad-keycode", callback: ((object: number) => void)): number
    on(sigName: "bad-keycode", callback: (object: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "bad-keycode", callback: (object: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "bad-keycode", callback: (object: number) => void): NodeJS.EventEmitter
...
class Status {
    ...
    off(sigName: "button-release-event", callback: (event: Gdk.EventButton) => void): NodeJS.EventEmitter
    emit(sigName: "button-release-event", event: Gdk.EventButton): void
    connect(sigName: "popup-menu", callback: ((button: number, activateTime: number) => void)): number
    on(sigName: "popup-menu", callback: (button: number, activateTime: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "popup-menu", callback: (button: number, activateTime: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "popup-menu", callback: (button: number, activateTime: number) => void): NodeJS.EventEmitter
    ...
    off(sigName: "scroll-event", callback: (event: Gdk.EventScroll) => void): NodeJS.EventEmitter
    emit(sigName: "scroll-event", event: Gdk.EventScroll): void
    connect(sigName: "size-changed", callback: ((size: number) => boolean)): number
    on(sigName: "size-changed", callback: (size: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "size-changed", callback: (size: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "size-changed", callback: (size: number) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::stock", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::stock", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::storage-type", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::storage-type", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class DesktopConfig {
    ...
    readonly groupPerApp: boolean
    readonly handleIndicators: boolean
    readonly layoutNamesAsGroupNames: boolean
    readonly loadExtraItems: boolean
    readonly settings: Gio.Settings
    readonly configListenerId: number
...
abstract class IndicatorClass {
    ...
    readonly reinitUi: (gki: Indicator) => void
    static name: string
}
class IndicatorConfig {
    ...
    readonly settings: Gio.Settings
    readonly imageFilenames: object[]
    readonly iconTheme: Gtk.IconTheme
    readonly configListenerId: number
    readonly engine: Xkl.Engine
...
class KeyboardConfig {
    ...
    readonly layoutsVariants: string
...
abstract class KeyboardDrawingClass {
    ...
    readonly badKeycode: (drawing: KeyboardDrawing, keycode: number) => void
    static name: string
}

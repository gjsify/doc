...
class FeedsPublisher {
    ...
    connect(sigName: "delete-subscription", callback: ((object: FeedChannel, p0: string) => void)): number
    ...
    connect(sigName: "new-subscription", callback: ((object: FeedChannel, p0: string) => void)): number

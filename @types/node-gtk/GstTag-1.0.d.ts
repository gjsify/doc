...
function tagImageDataToImageSample(imageData: Uint8Array, imageType: TagImageType): Gst.Sample
function tagListAddId3Image(tagList: Gst.TagList, imageData: Uint8Array, id3PictureType: number): boolean
...
function tagListFromVorbiscomment(data: Uint8Array, idData: Uint8Array): [ /* returnType */ Gst.TagList, /* vendorString */ string | null ]
function tagListFromVorbiscommentBuffer(buffer: Gst.Buffer, idData: Uint8Array): [ /* returnType */ Gst.TagList, /* vendorString */ string | null ]
function tagListFromXmpBuffer(buffer: Gst.Buffer): Gst.TagList
function tagListNewFromId3v1(data: Uint8Array): Gst.TagList
...
function tagListToVorbiscommentBuffer(list: Gst.TagList, idData: Uint8Array, vendorString?: string | null): Gst.Buffer
...
abstract class TagDemuxClass {
    ...
    readonly identifyTag: (demux: TagDemux, buffer: Gst.Buffer, startTag: boolean, tagSize: number) => boolean
    readonly parseTag: (demux: TagDemux, buffer: Gst.Buffer, startTag: boolean, tagSize: number, tags: Gst.TagList) => TagDemuxResult
    readonly mergeTags: (demux: TagDemux, startTags: Gst.TagList, endTags: Gst.TagList) => Gst.TagList
    static name: string
}
...
abstract class TagMuxClass {
    ...
    readonly parentClass: Gst.ElementClass
    readonly renderStartTag: (mux: TagMux, tagList: Gst.TagList) => Gst.Buffer
    readonly renderEndTag: (mux: TagMux, tagList: Gst.TagList) => Gst.Buffer
    static name: string
}
class TagMuxPrivate {
    static name: string

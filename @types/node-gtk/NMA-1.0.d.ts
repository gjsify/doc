...
class CertChooser {
    ...
    connect(sigName: "cert-password-validate", callback: (() => GLib.Error)): number
    ...
    connect(sigName: "cert-validate", callback: (() => GLib.Error)): number
    ...
    connect(sigName: "key-password-validate", callback: (() => GLib.Error)): number
    ...
    connect(sigName: "key-validate", callback: (() => GLib.Error)): number

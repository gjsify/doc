...
class Cabinet {
    ...
    connect(sigName: "notify::signature", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::signature", callback: ((pspec: GObject.ParamSpec) => void)): number

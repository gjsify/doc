...
class PropertiesDialog {
    ...
    setNetbookMode(enable: boolean): void
    setPage(page: PropertiesDialogPage): void
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::netbook-mode", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::netbook-mode", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::netbook-mode", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::netbook-mode", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::netbook-mode", callback: (...args: any[]) => void): NodeJS.EventEmitter
    connect(sigName: "notify::accept-focus", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::accept-focus", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::accept-focus", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::accept-focus", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    /* Static methods and pseudo-constructors */
    static new(parent: Gtk.Window, thumbview: ThumbView, nextImageAction: string, previousImageAction: string): PropertiesDialog
    /* Function overloads */
...
class Window {
    ...
    getImage(): Image
    getMode(): WindowMode
    getPropertiesDialog(): Gtk.Widget

...
class PasswordDialog {
    ...
    connect(sigName: "notify::anonymous-allowed", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::anonymous-allowed", callback: ((pspec: GObject.ParamSpec) => void)): number

...
class CompletionInfo {
    ...
    connect(sigName: "before-show", callback: (() => void)): number
    on(sigName: "before-show", callback: () => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "before-show", callback: () => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "before-show", callback: () => void): NodeJS.EventEmitter
...
class GutterRendererPixbuf {
    ...
    connect(sigName: "notify::stock-id", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::stock-id", callback: ((pspec: GObject.ParamSpec) => void)): number
...
abstract class CompletionInfoClass {
    ...
    readonly beforeShow: (info: CompletionInfo) => void
    static name: string
}
...
abstract class ViewClass {
    ...
    readonly moveLines: (view: View, copy: boolean, step: number) => void

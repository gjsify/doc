...
class BackendStore {
    ...
    connect(sigName: "backend-available", callback: ((backend: Backend) => void)): number
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::enabled-backends", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::enabled-backends", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class Backend {
    ...
    connect(sigName: "persona-store-added", callback: ((store: PersonaStore) => void)): number
    ...
    connect(sigName: "persona-store-removed", callback: ((store: PersonaStore) => void)): number
...
class Debug {
    ...
    connect(sigName: "print-status", callback: (() => void)): number
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::colour-enabled", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::colour-enabled", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::debug-output-enabled", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::debug-output-enabled", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class IndividualAggregator {
    ...
    connect(sigName: "individuals-changed", callback: ((added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
    ...
    connect(sigName: "individuals-changed-detailed", callback: ((changes: Gee.MultiMap) => void)): number
    ...
    once(sigName: "notify::is-quiescent", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::is-quiescent", callback: (...args: any[]) => void): NodeJS.EventEmitter
    connect(sigName: "notify::primary-store", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::primary-store", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::individuals", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::individuals", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class Individual {
    ...
    connect(sigName: "removed", callback: ((replacementIndividual?: Individual | null) => void)): number
    ...
    connect(sigName: "personas-changed", callback: ((added: Gee.Set, removed: Gee.Set) => void)): number
...
class StructuredName {
    ...
    connect(sigName: "notify::additional-names", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::additional-names", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::prefixes", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::prefixes", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::suffixes", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::suffixes", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class PersonaStore {
    ...
    connect(sigName: "personas-changed", callback: ((added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
...
class PostalAddress {
    ...
    connect(sigName: "notify::locality", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::locality", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::address-format", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::address-format", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class Role {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::organisation-name", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::organisation-name", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class SearchView {
    ...
    connect(sigName: "individuals-changed-detailed", callback: ((added: Gee.SortedSet, removed: Gee.SortedSet) => void)): number
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::aggregator", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::aggregator", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class SimpleQuery {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::query-string", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::query-string", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::query-locale", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::query-locale", callback: ((pspec: GObject.ParamSpec) => void)): number
...
abstract class AbstractFieldDetailsClass {
    ...
    readonly parametersEqual: (self: AbstractFieldDetails, that: AbstractFieldDetails) => boolean
    readonly valuesEqual: (self: AbstractFieldDetails, that: AbstractFieldDetails) => boolean
...
abstract class BackendClass {
    ...
    readonly disablePersonaStore: (self: Backend, store: PersonaStore) => void
    readonly enablePersonaStore: (self: Backend, store: PersonaStore) => void
    readonly setPersonaStores: (self: Backend, storeids?: Gee.Set | null) => void
    readonly prepare: (self: Backend, callback?: Gio.AsyncReadyCallback | null) => void
    readonly prepareFinish: (self: Backend, res: Gio.AsyncResult) => void
    readonly unprepare: (self: Backend, callback?: Gio.AsyncReadyCallback | null) => void
    readonly unprepareFinish: (self: Backend, res: Gio.AsyncResult) => void
    static name: string
}
...
abstract class ObjectCacheClass {
    ...
    readonly getSerialisedObjectType: (self: ObjectCache, objectVersion: number) => GLib.VariantType | null
    readonly getSerialisedObjectVersion: (self: ObjectCache) => number
    readonly serialiseObject: (self: ObjectCache, object?: object | null) => GLib.Variant
    readonly deserialiseObject: (self: ObjectCache, variant: GLib.Variant, objectVersion: number) => object | null
    static name: string
}
...
abstract class PersonaStoreClass {
    ...
    readonly prepare: (self: PersonaStore, callback?: Gio.AsyncReadyCallback | null) => void
    readonly prepareFinish: (self: PersonaStore, res: Gio.AsyncResult) => void
    readonly flush: (self: PersonaStore, callback?: Gio.AsyncReadyCallback | null) => void
    readonly flushFinish: (self: PersonaStore, res: Gio.AsyncResult) => void
    readonly addPersonaFromDetails: (self: PersonaStore, details: GLib.HashTable, callback?: Gio.AsyncReadyCallback | null) => void
    readonly addPersonaFromDetailsFinish: (self: PersonaStore, res: Gio.AsyncResult) => Persona | null
    readonly removePersona: (self: PersonaStore, persona: Persona, callback?: Gio.AsyncReadyCallback | null) => void
    readonly removePersonaFinish: (self: PersonaStore, res: Gio.AsyncResult) => void
    static name: string
}
...
abstract class PersonaClass {
    ...
    readonly linkablePropertyToLinks: (self: Persona, propName: string, callback: any) => void
    static name: string
}
...
abstract class QueryClass {
    ...
    readonly isMatch: (self: Query, individual: Individual) => number
    static name: string
}
class QueryPrivate {
    static name: string
...
abstract class AliasDetailsIface {
    ...
    readonly changeAlias: (self: AliasDetails, alias: string, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeAliasFinish: (self: AliasDetails, res: Gio.AsyncResult) => void
    readonly getAlias: (self: AliasDetails) => string
    readonly setAlias: (self: AliasDetails, value: string) => void
    static name: string
}
abstract class AntiLinkableIface {
    /* Fields of Folks-0.7.Folks.AntiLinkableIface */
    readonly changeAntiLinks: (self: AntiLinkable, antiLinks: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeAntiLinksFinish: (self: AntiLinkable, res: Gio.AsyncResult) => void
    readonly getAntiLinks: (self: AntiLinkable) => Gee.Set
    readonly setAntiLinks: (self: AntiLinkable, value: Gee.Set) => void
    static name: string
}
abstract class AvatarDetailsIface {
    /* Fields of Folks-0.7.Folks.AvatarDetailsIface */
    readonly changeAvatar: (self: AvatarDetails, avatar?: Gio.LoadableIcon | null, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeAvatarFinish: (self: AvatarDetails, res: Gio.AsyncResult) => void
    readonly getAvatar: (self: AvatarDetails) => Gio.LoadableIcon | null
    readonly setAvatar: (self: AvatarDetails, value?: Gio.LoadableIcon | null) => void
    static name: string
}
abstract class BirthdayDetailsIface {
    /* Fields of Folks-0.7.Folks.BirthdayDetailsIface */
    readonly changeBirthday: (self: BirthdayDetails, birthday?: GLib.DateTime | null, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeBirthdayFinish: (self: BirthdayDetails, res: Gio.AsyncResult) => void
    readonly changeCalendarEventId: (self: BirthdayDetails, eventId?: string | null, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeCalendarEventIdFinish: (self: BirthdayDetails, res: Gio.AsyncResult) => void
    readonly getBirthday: (self: BirthdayDetails) => GLib.DateTime | null
    readonly setBirthday: (self: BirthdayDetails, value?: GLib.DateTime | null) => void
    readonly getCalendarEventId: (self: BirthdayDetails) => string | null
    readonly setCalendarEventId: (self: BirthdayDetails, value?: string | null) => void
    static name: string
}
abstract class EmailDetailsIface {
    /* Fields of Folks-0.7.Folks.EmailDetailsIface */
    readonly changeEmailAddresses: (self: EmailDetails, emailAddresses: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeEmailAddressesFinish: (self: EmailDetails, res: Gio.AsyncResult) => void
    readonly getEmailAddresses: (self: EmailDetails) => Gee.Set
    readonly setEmailAddresses: (self: EmailDetails, value: Gee.Set) => void
    static name: string
}
abstract class ExtendedInfoIface {
    /* Fields of Folks-0.7.Folks.ExtendedInfoIface */
    readonly getExtendedField: (self: ExtendedInfo, name: string) => ExtendedFieldDetails | null
    readonly changeExtendedField: (self: ExtendedInfo, name: string, value: ExtendedFieldDetails, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeExtendedFieldFinish: (self: ExtendedInfo, res: Gio.AsyncResult) => void
    readonly removeExtendedField: (self: ExtendedInfo, name: string, callback?: Gio.AsyncReadyCallback | null) => void
    readonly removeExtendedFieldFinish: (self: ExtendedInfo, res: Gio.AsyncResult) => void
    static name: string
}
abstract class FavouriteDetailsIface {
    /* Fields of Folks-0.7.Folks.FavouriteDetailsIface */
    readonly changeIsFavourite: (self: FavouriteDetails, isFavourite: boolean, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeIsFavouriteFinish: (self: FavouriteDetails, res: Gio.AsyncResult) => void
    readonly getIsFavourite: (self: FavouriteDetails) => boolean
    readonly setIsFavourite: (self: FavouriteDetails, value: boolean) => void
    static name: string
}
abstract class GenderDetailsIface {
    /* Fields of Folks-0.7.Folks.GenderDetailsIface */
    readonly changeGender: (self: GenderDetails, gender: Gender, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeGenderFinish: (self: GenderDetails, res: Gio.AsyncResult) => void
    readonly getGender: (self: GenderDetails) => Gender
    readonly setGender: (self: GenderDetails, value: Gender) => void
    static name: string
}
abstract class GroupDetailsIface {
    /* Fields of Folks-0.7.Folks.GroupDetailsIface */
    readonly changeGroup: (self: GroupDetails, group: string, isMember: boolean, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeGroupFinish: (self: GroupDetails, res: Gio.AsyncResult) => void
    readonly changeGroups: (self: GroupDetails, groups: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeGroupsFinish: (self: GroupDetails, res: Gio.AsyncResult) => void
    readonly getGroups: (self: GroupDetails) => Gee.Set
    readonly setGroups: (self: GroupDetails, value: Gee.Set) => void
    static name: string
}
abstract class ImDetailsIface {
    /* Fields of Folks-0.7.Folks.ImDetailsIface */
    readonly changeImAddresses: (self: ImDetails, imAddresses: Gee.MultiMap, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeImAddressesFinish: (self: ImDetails, res: Gio.AsyncResult) => void
    readonly getImAddresses: (self: ImDetails) => Gee.MultiMap
    readonly setImAddresses: (self: ImDetails, value: Gee.MultiMap) => void
    static name: string
}
abstract class InteractionDetailsIface {
    /* Fields of Folks-0.7.Folks.InteractionDetailsIface */
    readonly getImInteractionCount: (self: InteractionDetails) => number
    readonly getLastImInteractionDatetime: (self: InteractionDetails) => GLib.DateTime | null
    readonly getCallInteractionCount: (self: InteractionDetails) => number
    readonly getLastCallInteractionDatetime: (self: InteractionDetails) => GLib.DateTime | null
    static name: string
}
abstract class LocalIdDetailsIface {
    /* Fields of Folks-0.7.Folks.LocalIdDetailsIface */
    readonly changeLocalIds: (self: LocalIdDetails, localIds: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeLocalIdsFinish: (self: LocalIdDetails, res: Gio.AsyncResult) => void
    readonly getLocalIds: (self: LocalIdDetails) => Gee.Set
    readonly setLocalIds: (self: LocalIdDetails, value: Gee.Set) => void
    static name: string
}
abstract class LocationDetailsIface {
    /* Fields of Folks-0.7.Folks.LocationDetailsIface */
    readonly changeLocation: (self: LocationDetails, location?: Location | null, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeLocationFinish: (self: LocationDetails, res: Gio.AsyncResult) => void
    readonly getLocation: (self: LocationDetails) => Location | null
    readonly setLocation: (self: LocationDetails, value?: Location | null) => void
    static name: string
}
abstract class NameDetailsIface {
    /* Fields of Folks-0.7.Folks.NameDetailsIface */
    readonly changeStructuredName: (self: NameDetails, name?: StructuredName | null, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeStructuredNameFinish: (self: NameDetails, res: Gio.AsyncResult) => void
    readonly changeFullName: (self: NameDetails, fullName: string, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeFullNameFinish: (self: NameDetails, res: Gio.AsyncResult) => void
    readonly changeNickname: (self: NameDetails, nickname: string, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeNicknameFinish: (self: NameDetails, res: Gio.AsyncResult) => void
    readonly getStructuredName: (self: NameDetails) => StructuredName | null
    readonly setStructuredName: (self: NameDetails, value?: StructuredName | null) => void
    readonly getFullName: (self: NameDetails) => string
    readonly setFullName: (self: NameDetails, value: string) => void
    readonly getNickname: (self: NameDetails) => string
    readonly setNickname: (self: NameDetails, value: string) => void
    static name: string
}
abstract class NoteDetailsIface {
    /* Fields of Folks-0.7.Folks.NoteDetailsIface */
    readonly changeNotes: (self: NoteDetails, notes: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeNotesFinish: (self: NoteDetails, res: Gio.AsyncResult) => void
    readonly getNotes: (self: NoteDetails) => Gee.Set
    readonly setNotes: (self: NoteDetails, value: Gee.Set) => void
    static name: string
}
abstract class PhoneDetailsIface {
    /* Fields of Folks-0.7.Folks.PhoneDetailsIface */
    readonly changePhoneNumbers: (self: PhoneDetails, phoneNumbers: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changePhoneNumbersFinish: (self: PhoneDetails, res: Gio.AsyncResult) => void
    readonly getPhoneNumbers: (self: PhoneDetails) => Gee.Set
    readonly setPhoneNumbers: (self: PhoneDetails, value: Gee.Set) => void
    static name: string
}
abstract class PostalAddressDetailsIface {
    /* Fields of Folks-0.7.Folks.PostalAddressDetailsIface */
    readonly changePostalAddresses: (self: PostalAddressDetails, postalAddresses: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changePostalAddressesFinish: (self: PostalAddressDetails, res: Gio.AsyncResult) => void
    readonly getPostalAddresses: (self: PostalAddressDetails) => Gee.Set
    readonly setPostalAddresses: (self: PostalAddressDetails, value: Gee.Set) => void
    static name: string
}
abstract class PresenceDetailsIface {
    /* Fields of Folks-0.7.Folks.PresenceDetailsIface */
    readonly getPresenceType: (self: PresenceDetails) => PresenceType
    readonly setPresenceType: (self: PresenceDetails, value: PresenceType) => void
    readonly getPresenceMessage: (self: PresenceDetails) => string
    readonly setPresenceMessage: (self: PresenceDetails, value: string) => void
    readonly getClientTypes: () => [ /* returnType */ string[], /* resultLength1 */ number ]
    readonly setClientTypes: (self: PresenceDetails, value: string[]) => void
    readonly getPresenceStatus: (self: PresenceDetails) => string
    readonly setPresenceStatus: (self: PresenceDetails, value: string) => void
    static name: string
}
abstract class RoleDetailsIface {
    /* Fields of Folks-0.7.Folks.RoleDetailsIface */
    readonly changeRoles: (self: RoleDetails, roles: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeRolesFinish: (self: RoleDetails, res: Gio.AsyncResult) => void
    readonly getRoles: (self: RoleDetails) => Gee.Set
    readonly setRoles: (self: RoleDetails, value: Gee.Set) => void
    static name: string
}
abstract class UrlDetailsIface {
    /* Fields of Folks-0.7.Folks.UrlDetailsIface */
    readonly changeUrls: (self: UrlDetails, urls: Gee.Set, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeUrlsFinish: (self: UrlDetails, res: Gio.AsyncResult) => void
    readonly getUrls: (self: UrlDetails) => Gee.Set
    readonly setUrls: (self: UrlDetails, value: Gee.Set) => void
    static name: string
}
abstract class WebServiceDetailsIface {
    /* Fields of Folks-0.7.Folks.WebServiceDetailsIface */
    readonly changeWebServiceAddresses: (self: WebServiceDetails, webServiceAddresses: Gee.MultiMap, callback?: Gio.AsyncReadyCallback | null) => void
    readonly changeWebServiceAddressesFinish: (self: WebServiceDetails, res: Gio.AsyncResult) => void
    readonly getWebServiceAddresses: (self: WebServiceDetails) => Gee.MultiMap
    readonly setWebServiceAddresses: (self: WebServiceDetails, value: Gee.MultiMap) => void
    static name: string
}
}

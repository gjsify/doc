...
class ClientCreateOptions {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::gpu-device", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::gpu-device", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::gpu-device", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::gpu-device", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
class ClientOptions {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::n-retries", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::n-retries", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::n-retries", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::n-retries", callback: (...args: any[]) => void): NodeJS.EventEmitter

...
class License {
    ...
    connect(sigName: "notify::map", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::map", callback: ((pspec: GObject.ParamSpec) => void)): number
...
abstract class LayerClass {
    ...
    readonly parentClass: Gtk.WidgetClass
    readonly getLicense: (self: Layer) => string | null
    readonly getLicenseUri: (self: Layer) => string | null
    static name: string
}

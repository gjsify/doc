...
class Blame {
    ...
    readonly parentInstance: ObjectFactoryBase
...
class Blob {
    ...
    readonly parentInstance: Native
    /* Fields of GObject-2.0.GObject.Object */
    readonly gTypeInstance: GObject.TypeInstance
...
abstract class BlameClass {
    ...
    readonly parentClass: NativeClass
    static name: string
}
class BlameHunk {
...
abstract class CheckoutOptionsClass {
    ...
    readonly progress: (options: CheckoutOptions, path: string, completedSteps: number, totalSteps: number) => void
    static name: string
}
...
abstract class CloneOptionsClass {
    ...
    readonly parentClass: GObject.ObjectClass
    readonly createRepository: (options: CloneOptions, path: string, isBare: boolean) => Repository | null
    readonly createRemote: (options: CloneOptions, repository: Repository, name: string, url: string) => Remote | null
    static name: string
}
...
abstract class CredSshKeyFromAgentClass {
    ...
    readonly parentClass: CredClass
    static name: string
}
class DiffBinary {
...
abstract class RemoteCallbacksClass {
    ...
    readonly transferProgress: (callbacks: RemoteCallbacks, stats: TransferProgress) => void
    readonly updateTips: (callbacks: RemoteCallbacks, refname: string, a: OId, b: OId) => void
    readonly completion: (callbacks: RemoteCallbacks, type: RemoteCompletionType) => void
    readonly credentials: (callbacks: RemoteCallbacks, url: string, usernameFromUrl: string | null, allowedTypes: Credtype) => Cred | null
    static name: string
}
